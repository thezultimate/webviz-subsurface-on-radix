...
# This file was generated by ingeknudsen on 2020-08-28.
...
if False and not webviz_config.is_reload_process():
    ...
    app.layout = dcc.Tabs(
        ...
        children=[
            ...
            # dcc.Tab(id="disk_usage",label="Disk usage",
            #     selected_className="selectedButton",
            #     className="styledButton",children=[
            #       standard_plugins.DiskUsage(app=app, **{'scratch_dir': PosixPath('.'), 'date': datetime.date(2020, 7, 11)}).plugin_layout(contact_person=None)
            #       ],
            # ),
